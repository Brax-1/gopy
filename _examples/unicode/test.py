...
#bytestr_ret = encoding.GopyvarString(bytestr)
unicodestr_ret = encoding.GopyvarString(unicodestr)

# binary_stdout.write(b"encoding.GopyvarString(bytestr) -> ")
# binary_stdout.write(bytestr_ret.encode('UTF-8'))
# binary_stdout.write(b'\n')
binary_stdout.write(b"encoding.GopyvarString(unicodestr) -> ")
