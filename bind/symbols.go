...
type symbol struct {
	...
	cgoname      string // type name of entity for cgo -- gopyvar for objs
	cpyname      string // type name of entity for cgo - python -- gopyvar..
...
func (sym *symtab) typeof(n string) *symbol {
	...
	case skType:
		return s
	default:
		panic(fmt.Errorf("ungopyvard symbol kind (%v)", s.kind))
	}
}
...
func (sym *symtab) addSymbol(obj types.Object) error {
	...
	default:
		return fmt.Errorf("gopy: gopyvard object [%#v]", obj)
	}
	return nil
}
...
func (sym *symtab) buildTuple(tuple *types.Tuple, varnm string, methvar string) (string, error) {
	...
	for i := 0; i < sz; i++ {
		...
		case vsym.hasGopyvar(): // note: assuming int64 gopyvars
		...
		default:
			return "", fmt.Errorf("buildTuple: type not gopyvard: %s", typ.String())
		}
	}
	return bstr, nil
}
...
func (sym *symtab) pyObjectToGo(typ types.Type, sy *symbol, objnm string) (string, error) {
	...
	default:
		return "", fmt.Errorf("pyObjectToGo: type not gopyvard: %s", typ.String())
	}
	return bstr, nil
}
...
func (sym *symtab) ZeroToGo(typ types.Type, sy *symbol) (string, error) {
	...
	default:
		return "", fmt.Errorf("ZeroToGo: type not gopyvard: %s", typ.String())
	}
	return bstr, nil
}
...
func (sym *symtab) addType(obj types.Object, t types.Type) error {
	...
	case *types.Named:
		...
		default:
			err = fmt.Errorf("ungopyvard named-type: [%T]\n%#v\n", obj, t)
		}
	...
	default:
		return fmt.Errorf("ungopyvard obj [%T]\ntype [%#v]", obj, t)
	}
	return nil
}
...
func (sym *symtab) addArrayType(pkg *types.Package, obj types.Object, t types.Type, kind symkind, id, n string) error {
	...
	sym.syms[fn] = &symbol{
		...
		id:      id,
		goname:  n,
		cgoname: "CGoGopyvar", // gopyvars
		cpyname: PyGopyvar,
		pysig:   "[]" + elsym.pysig,
		go2py:   "gopyvarFromPtr_" + id,
		py2go:   "deptrFromGopyvar_" + id,
		zval:    "nil",
	}
	return nil
}
